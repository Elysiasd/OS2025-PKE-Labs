...
// lib call to rcwd
//
ssize_t sys_user_rcwd(char * path, size_t len){
  char * p_path = (char*)user_va_to_pa((pagetable_t)(current->pagetable), (void*)path);
  return do_rcwd(p_path, len);
}
